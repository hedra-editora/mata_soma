...
\addcontentsline{toc}{chapter}{Apresentação, \emph{por Edson Passetti} \medskip}
\hedramarkboth{Apresentação}{}

\begin{flushright}
\textsc{edson passetti}\footnote[*]{Professor Livre"-Docente de Ciências Políticas da \versal{PUC"-SP}.}
\end{flushright}
...
\hedramarkboth{Conceitos básicos}{}
...
\hedramarkboth{uma psicologia libertária}{}
...
Em \emph{A função do orgasmo}, Reich mostra como o orgasmo sexual
...
O ato de governar não restringe"-se às instituições estatais e aos
...
Mais que nunca, a Soma afirma"-se como processo libertário, interessada
...
Sociabilidade Libertária (Nu"-Sol), da \versal{PUC"-SP}, contempladas nos trabalhos
de Edson Passetti, Acácio Augusto, Salete Oliveira, Thiago Rodriguez e
demais membros.

A formação de um somaterapeuta abrange um tempo de quatro anos em média.
